...
const drawDataList = e => {
  ...
  const searchHotel = (inputCity,inputCheckin,inputCheckout,inputRooms,inputAdults,inputChildrens) =>{
    ...
    api.open('POST','https://d93f77e8.ngrok.io/api/v1/scrap');
...
const detailsHotel = (nameLink) =>{
    ...
    detailsapi.open('POST','https://d93f77e8.ngrok.io/api/v1/scraphotel');
...
if(document.getElementById("detailsApp")){  drawHotelDetail() ;}
