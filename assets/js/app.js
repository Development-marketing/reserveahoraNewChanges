...
const drawDataList = e => {
  ...
  const searchHotel = (inputCity,inputCheckin,inputCheckout,inputRooms,inputAdults,inputChildrens) =>{
    ...
    api.open('POST','https://6d96eda6.ngrok.io/api/v1/scrap');
...
// //   searchHotel(); 
let session = document.getElementById("hotelName");
if(session){
...
const detailsHotel = (nameLink) =>{
        ...
        detailsapi.open('POST','https://6d96eda6.ngrok.io/api/v1/scraphotel');
